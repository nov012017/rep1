...
{	
  ...
  public void retesting(String br) throws Exception
  {
	  ...
	  //driver=new RemoteWebDriver(new URL("http://192.168.1.248:1234/wd/hub"), ds);
	  FileInputStream fin=new FileInputStream("e:\\18nov2017\\testdata.xlsx");
	  ...
	  for(int r=1;r<=ws.getLastRowNum();r++)
	  {
		...
		if(row.getCell(4).getStringCellValue().matches("yes"))
		{
			...
			Object o=c.newInstance();  // create instance for the class
			m.invoke(o,null);  //invoke the method
		}
	  }
